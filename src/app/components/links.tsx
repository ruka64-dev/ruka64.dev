...
export default function Links() {
	return (
		<div className='flex flex-row flex-wrap justify-center gap-3'>
			...
			<motion.div initial={{ y: 10, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1.2, delay: 1.0, type: 'spring', bounce: 0.7 }}>
			...
			<motion.div initial={{ y: 10, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1.2, delay: 1.1, type: 'spring', bounce: 0.7 }}>
